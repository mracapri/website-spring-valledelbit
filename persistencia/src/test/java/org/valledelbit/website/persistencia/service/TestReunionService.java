...
public class TestReunionService implements TestPrincipales{
	...
	public void testReadPorNombreLink() {
		...
		try {
			...
			// Obteniendo una reunion a travez del nombreLink
			Reunion leida = reunionService.getReunion(reunion.getNombreLink());
			
			// Si los nombreLinks son iguales   
			boolean result = reunion.getNombreLink().equals(leida.getNombreLink());
